...
CREATE TABLE IF NOT EXISTS INSCRITOS(
    ...
    NO_MUNICIPIO_RESIDENCIA     VARCHAR (150) NOT NULL , 
    CO_UF_RESIDENCIA            SMALLINT NOT NULL,
    ...
    CO_MUNICIPIO_NASCIMENTO     INTEGER NOT NULL ,
    NO_MUNICIPIO_NASCIMENTO     VARCHAR(150) NOT NULL,
    CO_UF_NASCIMENTO            SMALLINT NOT NULL ,
    ...
    CO_UF_ESC                   SMALLINT NOT NULL,
    SG_UF_ESC                   VARCHAR(2) NOT NULL,
    TP_DEPENDENCIA_ADM_ESC      SMALLINT NOT NULL,
    TP_LOCALIZACAO_ESC          TEXT NOT NULL,
